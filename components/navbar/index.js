  ...
  return (
    <>
      <div className="navbar border-b">
        <div className="navbar-inner w-full flex xl:grid xl:grid-flow-row xl:grid-cols-12 items-center">
            ...
            {web3_provider && address && (
              <>
                <a
                  ...
                  className="flex items-center uppercase text-purple-600 dark:text-purple-400 text-xs xl:text-sm font-medium mx-0 xl:mx-2"
                >
      ...
      {((!chains_status_data && address) || (!hiddenStatus)) && (
        <div className="w-full h-8 xl:h-10 bg-gray-100 dark:bg-gray-900 overflow-x-auto flex items-center py-2 px-2 sm:px-4">
          <span className="flex flex-wrap items-center font-mono text-purple-600 dark:text-purple-400 text-2xs xl:text-sm space-x-1.5 xl:space-x-2 mx-auto">
            {!chains_status_data && address ?
              <>
                <Grid color={theme === 'dark' ? '#7c1aed' : '#7c3aed'} width="16" height="16" />

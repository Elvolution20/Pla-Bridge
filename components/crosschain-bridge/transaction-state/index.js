...
export default function TransactionState({ defaultHidden = false, data, onClose, onFinish, cancelDisabled, buttonTitle, buttonClassName }) {
  ...
  const fulfillButton = (
    <button
      ...
      className={`w-full max-w-xs rounded-2xl shadow-lg flex items-center justify-center ${actionDisabled ? 'bg-purple-400 dark:bg-purple-500 cursor-not-allowed text-gray-100' : 'bg-purple-600 hover:bg-purple-700 dark:bg-purple-700 dark:hover:bg-purple-800 text-gray-100 hover:text-white'} text-base sm:text-lg space-x-${transfering === 'fulfill' ? 2.5 : 1.5} mx-auto py-3.5 px-2.5`}
    >
      {transfering === 'fulfill' ?
  ...
  const cancelButton = canCancelSendingTx && (
    chain_id !== (canCancelSendingTx ? generalTx?.sendingChainId : generalTx?.receivingChainId) ?
      ...
      >
        {transfering === 'cancel' && (
          <TailSpin color={theme === 'dark' ? 'white' : '#7c3aed'} width="16" height="16" />
        )}
  ...
  const manualClaimLink = transaction?.transactionId && (
    <a
      ...
      className="underline text-purple-600 dark:text-white font-semibold"
    >
    ...
    <>
      {transferResponse && !finish && (
        <Notification
          ...
          innerClassNames={`${transferResponse.status === 'failed' ? 'bg-red-500 dark:bg-red-600' : transferResponse.status === 'success' ? 'bg-green-500 dark:bg-green-600' : 'bg-purple-600 dark:bg-purple-700'} text-white`}
          ...
          <div className="flex items-center">
            ...
            <div className="flex items-center space-x-1.5 mr-2">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="text-purple-600 dark:text-white text-sm sm:text-base font-semibold"
              >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center text-purple-600 dark:text-white text-sm font-medium ml-auto"
            >
          ...
          <div className="overflow-x-scroll lg:overflow-x-visible flex flex-col sm:flex-row items-center sm:items-start sm:justify-between space-y-8 sm:space-y-0 mt-3">
            ...
            <div className="mx-auto">
              <div className="min-w-max grid grid-flow-row grid-cols-3 gap-2">
                <span />
                <Img
                  src="/logos/externals/connext/logo.svg"
                  alt=""
                    ...
                    <>
                      <div className="flex items-center justify-start sm:justify-center text-gray-400 dark:text-gray-600 text-xs font-medium space-x-1 mt-1.5">
                        ...
                        <a
                          ...
                          rel="noopener noreferrer"
                        >
                          <span className="text-purple-600 dark:text-white font-semibold">
                            {ens_data[generalTx.router.id.toLowerCase()].name}
                          </span>
                        </a>
                      </div>
                    ...
                    <>
                      <div className="flex items-center justify-center font-medium space-x-1 mt-2">
                        <a
                          ...
                          rel="noopener noreferrer"
                        >
                          <span className="text-purple-600 dark:text-white text-xs font-medium">
                            {ellipseAddress(generalTx.router.id, 6)}
                          </span>
                        </a>
            ...
            {web3_provider && !finish && (
              <div className="sm:order-2 flex flex-col items-center justify-center space-y-3">
                ...
                {loaded && [sendingTx?.status, receivingTx?.status].includes('Prepared') && (canCancelSendingTx || ['Prepared'].includes(receivingTx?.status)) ?
                  ...
                  :
                  <>
                    <Triangle color={theme === 'dark' ? 'white' : '#7c3aed'} width="72" height="72" />
                    <div className="flex items-center space-x-1 ml-2">
                      <span className="text-purple-600 dark:text-white font-light">
                        {loaded ? transfering === 'fulfill' ? 'Claiming' : transfering === 'cancel' ? 'Cancelling' : 'Waiting for Router' : 'Loading'}
                      </span>
                      <Oval color={theme === 'dark' ? 'white' : '#7c3aed'} width="14" height="14" />
                    </div>
                  </>
                }
              </div>
              ...
              <div className="sm:order-2 flex flex-col items-center justify-center space-y-5">
                ...
                <div className="flex flex-col items-center">
                  ...
                  {transaction?.transactionId && (
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex items-center text-purple-600 dark:text-purple-400 text-base font-semibold"
                    >
                ...
                {process.env.NEXT_PUBLIC_FEEDBACK_URL && (
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="underline text-purple-600 text-xs font-medium"
                  >
          ...
          {transaction?.transactionId && !finish && !['Prepared'].includes(receivingTx?.status) && (
            <div className="space-y-2">
              <div className="flex items-center font-semibold space-x-2">
                <span className="text-purple-600 dark:text-white text-base">Transaction in progress</span>
                <Bars color={theme === 'dark' ? 'white' : '#7c3aed'} width="18" height="18" />
              </div>

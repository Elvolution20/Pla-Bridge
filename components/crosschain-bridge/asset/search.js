      ...
      <div className="relative">
        <div className="flex items-center justify-between">
          <input
            ...
            type="search"
            placeholder="Search..."
            className="w-4/6 h-10 bg-transparent appearance-none border-gray-300 focus:border-purple-500 dark:border-gray-700 focus:ring-purple-600 dark:focus:ring-gray-600 rounded-3xl text-sm pl-10 pr-5"
          />

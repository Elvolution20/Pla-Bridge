...
const protocols = [
  {
    ...
    title: 'Planetopia',
    image: {
      light: '/logos/externals/planetopia/logo.svg',
      dark: '/logos/externals/planetopia/logo_white.svg',
    },
  ...
  },
  {
    ...
    title: 'Nomad',
    image: {
      light: '/logos/externals/nomad/logo.svg',
      dark: '/logos/externals/nomad/logo_white.svg',
    },
...
export default function CrosschainBridge() {
  ...
  const fromBalanceComponent = address && swapConfig.fromChainId && fromAsset && (
    <div className={`flex items-center font-mono ${fromBalanceAmount > 0 ? 'text-green-500 dark:text-white font-semibold' : 'text-gray-400 dark:text-gray-600'} space-x-1`}>
      {balances_data?.[swapConfig.fromChainId] ?
        ...
        :
        <TailSpin color={theme === 'dark' ? 'white' : '#7c3aed'} width="20" height="20" />
      }
    </div>
  )
  ...
  const allowanceComponent = (
    <>
      <div className={`flex items-center ${infiniteApproval || unlimitAllowance ? 'text-purple-500 dark:text-white' : 'text-gray-400 dark:text-gray-600'} space-x-0.5`}>
    ...
    <>
      {tokenApproveResponse && (
        <Notification
          ...
          innerClassNames={`${tokenApproveResponse.status === 'failed' ? 'bg-red-500 dark:bg-red-600' : tokenApproveResponse.status === 'success' ? 'bg-green-500 dark:bg-green-600' : 'bg-purple-600 dark:bg-purple-700'} text-white`}
        ...
        <div className="col-span-1 lg:col-span-4">
          <div className="space-y-4 mt-8">
            {announcement_data?.data && (
              <Alert
                color="xl:max-w-lg bg-yellow-400 dark:bg-purple-600 text-white text-left mx-auto"
              ...
              <div className="flex items-center justify-between space-x-3">
                ...
                {toChain && (
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="min-w-max bg-gray-50 hover:bg-gray-100 dark:bg-black dark:hover:bg-gray-900 cursor-pointer rounded-xl flex items-center text-purple-600 dark:text-purple-400 py-1.5 px-2.5"
                  >
                    <Img
                      src={toChain.image}
                      alt=""
                    ...
                    />
                    <span className="text-base font-medium">Add Liquidity</span>
                    <TiArrowRight size={20} className="transform -rotate-45 mt-0.5 -mr-1" />
                  </a>
                )}
              </div>
              <div className="bg-gray-300 dark:bg-gray-900 rounded-xl shadow-md space-y-8 sm:space-y-6 p-8 sm:p-6">
                <div className="grid grid-flow-row grid-cols-1 sm:grid-cols-5 gap-6">
                  <div className="sm:col-span-2 flex flex-col items-center sm:items-start">
                    <div className="w-48 flex items-center justify-center space-x-1.5">
                      <span className="text-purple-600 dark:text-purple-400 text-lg font-medium text-center">From</span>
                      {gas_prices_data?.[fromChain?.chain_id]?.gas_price && (
                        <Popover
                          ...
                          content={<div className="flex flex-col">
                            <div className="flex items-center space-x-1">
                              <span className="text-purple-600 dark:text-purple-400">Gas Price:</span>
                              <span className="font-semibold">
                                {gas_prices_data[fromChain.chain_id].gas_price} Gwei
                              </span>
                            </div>
                            <div className="flex items-center space-x-1">
                              <span className="text-purple-600 dark:text-purple-400">Updated at:</span>
                              <span className="font-semibold">
                        ...
                        >
                          <div className="flex items-center text-gray-900 dark:text-white space-x-1">
                  ...
                  <div className="flex items-center justify-center">
                    ...
                    >
                      <MdSwapVerticalCircle size={40} className="sm:hidden rounded-full shadow text-purple-600 hover:text-purple-400 dark:text-purple-600 dark:hover:text-purple-400" />
                      <MdSwapHorizontalCircle size={40} className="hidden sm:block rounded-full shadow text-purple-600 hover:text-purple-400 dark:text-purple-600 dark:hover:text-purple-400" />
                    </button>
                  </div>
                  <div className="sm:col-span-2 flex flex-col items-center sm:items-end">
                    <div className="w-48 flex items-center justify-center space-x-1.5">
                      <span className="text-purple-600 dark:text-purple-400 text-lg font-medium text-center">To</span>
                ...
                {supportNomad && (
                  <div className="grid grid-flow-row grid-cols-1 sm:grid-cols-5 gap-6 sm:mx-3">
                    <div className="sm:col-span-2 flex items-center justify-center sm:justify-start">
                      <span className="text-purple-600 dark:text-purple-400 text-base">via Protocol</span>
                    </div>
                      ...
                      {protocols.map((p, i) => (
                        ...
                        >
                          <button
                            ...
                            className={`${p.id === bridgeProtocol ? 'ring-2 ring-purple-600 dark:ring-purple-400' : ''} rounded-xl shadow py-1 px-2`}
                          >
                            <img
                              src={p.image?.[theme]}
                              alt=""
                ...
                {swapConfig.fromAssetId && (
                  <div className="grid grid-flow-row grid-cols-1 sm:grid-cols-5 gap-6 sm:ml-3">
                    <div className="sm:col-span-2 flex items-center justify-center sm:justify-start space-x-2.5">
                      <span className="text-gray-900 dark:text-gray-600 text-base">Amount</span>
                      {address && isSupport() && balances_data?.[swapConfig.fromChainId] && (
                        ...
                        >
                          <button
                            ...
                            className="bg-gray-900 hover:bg-gray-100 dark:bg-gray-800 dark:hover:bg-gray-700 rounded-xl shadow font-mono text-purple-600 hover:text-purple-400 dark:text-gray-200 dark:hover:text-white text-base font-semibold py-0.5 px-2.5"
                          >
                            Max
                          </button>
                        </Popover>
                ...
                {isSupport() && web3_provider && !useNomad && (estimatingAmount || estimatingFees || typeof estimatedFees === 'number') && (
                  <div className="grid grid-flow-row grid-cols-1 sm:grid-cols-5 gap-6 sm:mx-3">
                    <div className="sm:col-span-2 flex items-center justify-center sm:justify-start">
                      <span className="text-purple-600 dark:text-purple-400 text-base">{estimatedAmount || estimatingAmount ? '' : 'Estimated '}Fees</span>
                    </div>
                    <div className="sm:col-span-3 flex items-center justify-center sm:justify-end">
                      {estimatingAmount || estimatingFees || typeof estimatedFees !== 'number' ?
                        <div className="flex items-center space-x-1.5">
                          <span className="text-purple-600 dark:text-purple-400 text-base font-light">
                            {estimatedAmount || estimatingAmount ? 'Calculating' : 'Estimating'}
                          </span>
                          <Triangle color={theme === 'dark' ? 'white' : '#7c3aed'} width="24" height="24" />
                        </div>
                        :
                        typeof estimatedFees === 'number' ?
                          ...
                          :
                          <div className="font-mono text-gray-900 dark:text-gray-600">n/a</div>
                      }
                    </div>
                  </div>
                )}
                {isSupport() && web3_provider && !useNomad && typeof swapConfig.amount === 'number' && (
                  <div className="grid grid-flow-row grid-cols-1 sm:grid-cols-5 gap-6 sm:mx-3">
                    <div className="sm:col-span-2 min-w-max flex items-center justify-center sm:justify-start space-x-2.5">
                      <span className="text-purple-600 dark:text-purple-400 text-base">Estimated Received</span>
                      {!swapData && !swapResponse && estimatedAmount && !estimatingAmount && (
                        <button
                          onClick={() => setEstimateTrigger(moment().valueOf())}
                          className="bg-gray-50 hover:bg-gray-100 dark:bg-gray-800 dark:hover:bg-gray-700 rounded-full shadow flex items-center justify-center text-purple-400 hover:text-purple-600 dark:text-gray-600 dark:hover:text-white p-1 z-10"
                        >
                          <BiRefresh size={20} />
                        </button>
                      )}
                        ...
                        <div className="sm:w-48 flex items-center justify-end text-right">
                          {estimatingAmount || estimatingFees ?
                            ...
                            typeof confirmAmountReceived === 'number' ?
                              ...
                              :
                              <span className="text-gray-900 dark:text-gray-600 font-normal">n/a</span>
                          }
                        </div>
                ...
                {!useNomad && address && swapConfig.fromAssetId && fromContract?.contract_address !== constants.AddressZero && typeof swapConfig.amount === 'number' && (
                  <div className="grid grid-flow-row grid-cols-2 sm:grid-cols-5 gap-6 sm:mx-3">
                    <div className="sm:col-span-2 flex items-center justify-start space-x-2">
                      <span className="text-purple-600 dark:text-purple-400 text-base">Allowance</span>
                      <Popover
                        placement="top"
                        title="Allowance"
                      ...
                      >
                        <BsQuestionCircle size={16} className="text-purple-600 dark:text-purple-400" />
                      </Popover>
                    </div>
                ...
                {isSupport() && (swapData || balances_data?.[swapConfig.fromChainId]) && (typeof swapConfig.amount === 'number' || (mustChangeChain && web3_provider)) ?
                  mustChangeChain && web3_provider ?
                    <Wallet
                      ...
                      buttonDisconnectClassName="w-full bg-purple-500 hover:bg-purple-600 dark:bg-purple-600 dark:hover:bg-purple-700 rounded-2xl flex items-center justify-center text-white text-sm sm:text-base space-x-1.5 sm:space-x-2 py-3 sm:py-4 px-2 sm:px-3"
                    />
                    :
                      ...
                      !swapData && swapConfig.amount < estimatedFees ?
                        ...
                        !swapData && check_balances && maxBalanceAmount < swapConfig.amount ?
                          ...
                          useNomad ?
                            swapResponse ?
                              <Alert
                                color={`${swapResponse.status === 'failed' ? 'bg-red-400 dark:bg-red-500' : swapResponse.status === 'success' ? 'bg-green-400 dark:bg-green-500' : 'bg-purple-400 dark:bg-purple-500'} text-white text-base`}
                              ...
                              <ModalConfirm
                                ...
                                buttonClassName="w-full bg-purple-500 hover:bg-purple-600 dark:bg-purple-600 dark:hover:bg-purple-700 rounded-2xl flex items-center justify-center text-white text-base sm:text-lg space-x-1 py-3 sm:py-4 px-2 sm:px-3"
                                  ...
                                  <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between space-y-1 sm:space-y-0 sm:space-x-2 xl:space-x-2.5">
                                    ...
                                    <div className="sm:text-right">
                                      ...
                                      {swapConfig.amount && typeof tokenPrice === 'number' && (
                                        <div className="font-mono text-purple-500 sm:text-right">
                                ...
                                confirmButtonClassName="w-full btn btn-default btn-rounded bg-purple-500 hover:bg-purple-600 dark:bg-purple-600 dark:hover:bg-purple-700 text-white text-base sm:text-lg text-center"
                              />
                            :
                              ...
                              activeTransactionOpen ?
                                ...
                                !swapData && !swapResponse && !estimatedAmountResponse && (estimatedAmount || estimatingAmount) ?
                                  <div>
                                    ...
                                    {estimatingAmount ?
                                      <button
                                        ...
                                        className={`w-full ${estimatingAmount ? 'bg-purple-400 dark:bg-purple-500 cursor-not-allowed' : 'bg-purple-500 hover:bg-purple-600 dark:bg-purple-600 dark:hover:bg-purple-700'} rounded-2xl flex items-center justify-center text-white text-xs sm:text-lg space-x-1.5 sm:space-x-2 py-3 sm:py-4 px-2 sm:px-3`}
                                      >
                                        {estimatingAmount ?
                                          <>
                                      ...
                                      mustApproveToken ?
                                        (typeof tokenApproved === 'boolean' || tokenApproved) && (
                                          <button
                                            ...
                                            className={`w-full ${actionDisabled ? 'bg-purple-400 dark:bg-purple-500 cursor-not-allowed' : 'bg-purple-500 hover:bg-purple-600 dark:bg-purple-600 dark:hover:bg-purple-700'} rounded-2xl flex items-center justify-center text-white text-base sm:text-lg space-x-2 py-3 sm:py-4 px-2 sm:px-3`}
                                          >
                                            {tokenApproveResponse?.status === 'pending' ?
                                              <>
                                                <TailSpin color={theme === 'dark' ? 'white' : 'white'} width="24" height="24" />
                                            ...
                                            <div className="flex items-center space-x-6 mx-auto pt-2 pb-1">
                                              ...
                                              <div className="flex flex-col items-center space-y-1">
                                                <Img
                                                  ...
                                                  className="w-10 h-10 rounded-full"
                                                />
                                                <span className="text-purple-600 dark:text-purple-400 font-medium">{chainTitle(confirmToChain)}</span>
                                              </div>
                                            </div>
                                            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-1 sm:space-y-0 sm:space-x-2 xl:space-x-2.5">
                                              <div className="flex items-center text-purple-600 dark:text-purple-400 text-lg md:text-sm lg:text-base">
                                                Receiving Address
                                                <span className="hidden sm:block">:</span>
                                              </div>
                                              {receivingAddress && (
                                                  ...
                                                  {/* hotfix */false && !confirmFeesCollapsed && (
                                                    <div className="flex flex-col items-start sm:items-end py-1.5">
                                                      <div className="w-full grid grid-flow-row grid-cols-2 gap-1.5">
                                                        <span className="flex items-center text-purple-600 dark:text-purple-400 text-sm mr-4">
                                                          Dest. TX
                                                          <Popover
                                                            placement="bottom"
                                                            title="Dest. TX"
                                  ...
                                  !swapData && estimatedAmountResponse ?
                                    <Alert
                                      color={`${estimatedAmountResponse.status === 'failed' ? 'bg-red-400 dark:bg-red-500' : estimatedAmountResponse.status === 'success' ? 'bg-green-400 dark:bg-green-500' : 'bg-purple-400 dark:bg-purple-500'} text-white text-base`}
                                    ...
                                    !swapData && swapResponse ?
                                      ...
                                      swapData ?
                                        <TransactionState
                                          ...
                                          buttonClassName="hidden w-full bg-purple-500 hover:bg-purple-600 dark:bg-purple-600 dark:hover:bg-purple-700 rounded-2xl text-white text-base sm:text-lg text-center py-3 sm:py-4 px-2 sm:px-3"
                                        />
                                        :
                                        estimateTrigger ?
                                          <Alert
                                            color="bg-purple-400 dark:bg-purple-500 text-left text-white"
                                          ...
                                          >
                                            <div className="flex items-center justify-between space-x-2">
                                              ...
                                              <button
                                                onClick={() => setEstimateTrigger(moment().valueOf())}
                                                className="bg-purple-500 dark:bg-purple-400 rounded-full flex items-center justify-center text-white p-1"
                                              >
                                                <BiRefresh size={20} />
                                              </button>
                                            </div>
                  ...
                  web3_provider ?
                    ...
                    <Wallet
                      ...
                      buttonConnectClassName="w-full bg-purple-500 hover:bg-purple-600 dark:bg-purple-600 dark:hover:bg-purple-700 rounded-2xl text-white text-base sm:text-lg text-center py-3 sm:py-4 px-2 sm:px-3"
                    />
                }
              </div>
            </div>

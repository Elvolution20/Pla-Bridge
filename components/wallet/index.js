    ...
    <>
      {web3_provider ?
        ...
        <button
          disabled={disabled}
          onClick={connect}
          className={buttonConnectClassName || 'bg-purple-500 hover:bg-purple-600 dark:bg-purple-600 dark:hover:bg-purple-700 rounded-lg text-white font-medium py-1 px-2'}

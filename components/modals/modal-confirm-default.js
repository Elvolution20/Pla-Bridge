  ...
  return (
    <>
      <button
        type="button"
        onClick={show}
        className={buttonClassName || 'btn btn-default btn-rounded bg-purple-500 hover:bg-purple-600 text-white'}
      >
        {buttonTitle}
      </button>
      {open && (
              ...
              <div className="modal-content">
                ...
                <div className="modal-footer space-x-2">
                  ...
                  <button
                    ...
                    className={confirmButtonClassName || 'btn btn-default btn-rounded bg-purple-500 hover:bg-purple-600 text-white'}
                  >

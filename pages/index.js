...
export default function Index() {
  ...
  return (
    <>
      <CrossChainBridge />
      <div className="bg-red-300 dark:bg-black dark:bg-purple-500 dark:bg-yellow-500 dark:bg-green-400 dark:bg-green-600 dark:bg-red-700 dark:bg-gray-700 break-all xl:col-span-2 xl:col-span-4" />
    </>
  )
}